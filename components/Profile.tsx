...
const Profile: React.FC<ProfileProps> = ({ user, betHistory, events }) => {
  ...
  return (
    <div className="h-full bg-black text-white flex flex-col items-center pt-8 pb-24 px-6 relative overflow-y-auto no-scrollbar font-sans">
        ...
        {/* 2. The BLACK CARD */}
        <div className="w-full aspect-[1.586/1] bg-gradient-to-br from-zinc-800 to-zinc-950 border border-zinc-800 rounded-3xl p-6 relative overflow-hidden shadow-2xl z-10 flex flex-col justify-between group mx-auto max-w-sm shrink-0">
            {/* Texture */}
            ...
            <div className="relative z-10 flex justify-between items-end mt-4">
                 <div className="text-[9px] text-zinc-500 font-mono tracking-widest uppercase space-y-1">
                    <div>PENDING WINS: {pendingWinnings}</div>
