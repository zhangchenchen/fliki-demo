...
const VideoFeed: React.FC<VideoFeedProps> = ({ events, userBets, onVote }) => {
  ...
  return (
    ...
    >
                            ...
                            `}>
                                ...
                                <div className="text-right relative z-10">
                                    ...
                                    <div className="text-xl font-black text-yellow-400 font-mono">
                                        {Math.floor(userBet.amount * (userBet.side === 'A' ? multA : multB))}
                                    </div>
                                </div>
      ...
      {showSuccessModal && (
        <PredictionSuccessModal onClose={() => setShowSuccessModal(false)} />
      )}
    </div>
  );
};
